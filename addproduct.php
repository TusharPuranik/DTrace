...
<html lang="en">
  <head>
    ...
    <link rel="SHORTCUT ICON" href="./images/LetD.jpg" type="image/x-icon" />
    <link rel="ICON" href="./images/LetD.jpg" type="image/ico" />

    <title>DTrace - Add New ProDTrace</title>
  ...
  <body class="violetgradient">
            ...
            <div class="greyarea">
                ...
                <form id="form1" autocomplete="off">
                    <div class="formitem">
                        ...
                        <label type="text" class="formlabel"> Type </label>
                        <select class="formselect" data-live-search="true" name="type" id="type" requried>
                        ...
                        <input type="number" class="forminput" id="quantity" name="quantity" required>
    ...
    $('#form1').on('submit', function(event) {
        ...
        username = $('#user').val(); 
        // prodname=prodname+"<br>Registered By: "+username+ "<br>Type : " + type+ "<br>Quantity : " + quantity;
        console.log(prodname);
        var today = new Date();
        var thisdate = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();

        web3.eth.getAccounts().then(async function(accounts) {
          var receipt = await contract.methods.newItem(prodname,quantity,type,thisdate).send({ from: accounts[0], gas: 1000000 })
          .then(receipt => {
  ...
  $("#aboutbtn").on("click", function(){
      showAlert("A dual-use chemical tracking system that utilizes supply chain data is a technological solution that can serve both commercial and security purposes. This system involves the monitoring and tracing of chemical substances from their origin point to their final destination across the supply chain, including manufacturing, transportation, and distribution.");
  });
