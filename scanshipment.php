...
<html lang="en">
  <head>
    ...
    <title>DTrace - Scan Shipments</title>
        ...
        <div class="mycardstyle">
            <div class="greyarea">
                ...
                <form id="form2" autocomplete="off">
                    ...
                    <div class="formitem">
                        <label type="text" class="formlabel"> Recieved Quantity </label>
                        <input type="text" class="forminput" id="Rquant" required>
  ...
  <!-- JQuery -->
    ...
    $('#form2').on('submit', function(event) {
        ...
        web3.eth.getAccounts().then(async function(accounts) {
          var receipt = await contract.methods.addState(prodid,Rquant,info).send({ from: accounts[0], gas: 1000000 })
          .then(receipt => {
  ...
  function showAlert(message){
    ...
    $("#aboutbtn").on("click", function(){
        showAlert("A Decentralised End to End Logistics Application that stores the whereabouts of product at every freight hub to the Blockchain. At consumer end, customers can easily scan product's QR CODE and get complete information about the provenance of that product hence empowering	consumers to only purchase authentic and quality proDTrace.");
    });
